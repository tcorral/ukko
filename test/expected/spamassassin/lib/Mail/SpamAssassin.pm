...
if ('$LastChangedDate: 2015-04-28 22:39:45 +0200 (Tue, 28 Apr 2015) $' =~ ':') {
  # Subversion keyword "$LastChangedDate: 2015-04-28 22:39:45 +0200 (Tue, 28 Apr 2015) $" has been successfully expanded.
  # Doesn't happen with automated launchpad builds:
  # https://bugs.launchpad.net/launchpad/+bug/780916
  $SUB_VERSION = (split(/\s+/,'$LastChangedDate: 2015-04-28 22:39:45 +0200 (Tue, 28 Apr 2015) $ updated by SVN'))[1];
}


if (defined $IS_DEVEL_BUILD && $IS_DEVEL_BUILD) {
  if ('$LastChangedRevision: 1676621 $' =~ ':') {
    # Subversion keyword "$LastChangedRevision: 1676621 $" has been successfully expanded.
    push(@EXTRA_VERSION, ('r' . qw{$LastChangedRevision: 1676621 $ updated by SVN}[1]));
  } else {
